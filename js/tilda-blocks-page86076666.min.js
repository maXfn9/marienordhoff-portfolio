...
function t827_initMasonry(rec,recid,grid,eventType){var gutterElement=rec.querySelector('.t827__gutter-sizer');var gutterWidth;grid.classList.add('t827__grid_load');if(gutterElement&&(gutterElement.offsetWidth===40||window.getComputedStyle(gutterElement).width==='40px')){gutterWidth=39}else{gutterWidth='#rec'+recid+' .t827__gutter-sizer'}
...
grid.classList.remove('t827__grid_load')})}
